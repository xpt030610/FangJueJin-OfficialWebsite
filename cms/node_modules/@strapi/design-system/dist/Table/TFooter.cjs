"use strict";Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const u=require("react"),s=require("prop-types"),c=require("styled-components"),r=require("../Box/Box.cjs"),p=require("../Divider/Divider.cjs"),y=require("../Typography/Typography.cjs"),f=require("../Flex/Flex.cjs"),o=e=>e&&typeof e=="object"&&"default"in e?e:{default:e},t=o(u),a=o(s),i=o(c),g=i.default(r.Box)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;

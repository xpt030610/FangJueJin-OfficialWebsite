"use strict";Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const L=require("react"),k=require("styled-components"),q=require("prop-types"),g=require("@strapi/icons"),d=require("../../VisuallyHidden/VisuallyHidden.cjs"),u=require("./PaginationContext.cjs"),T=require("../../Typography/Typography.cjs"),x=require("../../themes/utils.cjs"),E=require("../../BaseLink/BaseLink.cjs"),c=e=>e&&typeof e=="object"&&"default"in e?e:{default:e},a=c(L),s=c(k),l=c(q),v=s.default(T.Typography)`
  line-height: revert;
`,w={active:!0},p=s.default(E.BaseLink).withConfig({shouldForwardProp:(e,t)=>!w[e]&&t(e)})`

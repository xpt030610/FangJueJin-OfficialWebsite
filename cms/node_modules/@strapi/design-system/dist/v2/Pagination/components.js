...
import { BaseLink as k } from "../../BaseLink/BaseLink.js";
const m = s(P)`
  line-height: revert;
`, w = {
  active: !0
...
`, h = t.forwardRef(({ children: e, ...r }, a) => {
  ...
  return /* @__PURE__ */ t.createElement(u, {
    ...
    tabIndex: o ? -1 : void 0,
    ...r
  }, /* @__PURE__ */ t.createElement(l, null, e), /* @__PURE__ */ t.createElement(b, {
    "aria-hidden": !0
  }));
});
...
const f = t.forwardRef(({ children: e, ...r }, a) => {
  ...
  return /* @__PURE__ */ t.createElement(u, {
    ...
    tabIndex: n ? -1 : void 0,
    ...r
  }, /* @__PURE__ */ t.createElement(l, null, e), /* @__PURE__ */ t.createElement(y, {
    "aria-hidden": !0
  }));
});
...
const v = t.forwardRef(({ number: e, children: r, ...a }, i) => {
  ...
  return /* @__PURE__ */ t.createElement(L, {
    ...
    ...a,
    active: n
  }, /* @__PURE__ */ t.createElement(l, null, r), /* @__PURE__ */ t.createElement(m, {
    "aria-hidden": !0,
    variant: "pi",
    fontWeight: n ? "bold" : null
  }, e));
});
v.displayName = "PageLink";
const x = ({ children: e, ...r }) => /* @__PURE__ */ t.createElement($, {
  ...r,
  as: "div"
}, /* @__PURE__ */ t.createElement(l, null, e), /* @__PURE__ */ t.createElement(m, {
  "aria-hidden": !0,
  variant: "pi"
}, "\u2026"));
v.propTypes = {

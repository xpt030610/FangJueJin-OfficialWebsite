"use strict";Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const h=require("react"),m=require("styled-components"),v=require("prop-types"),b=require("../../Box/Box.cjs"),$=require("../../Flex/Flex.cjs"),o=require("../../Typography/Typography.cjs"),T=require("./MainNavContext.cjs"),x=require("../../Tooltip/Tooltip.cjs"),B=require("../../Badge/Badge.cjs"),j=require("../../BaseLink/BaseLink.cjs"),i=e=>e&&typeof e=="object"&&"default"in e?e:{default:e},t=i(h),s=i(m),a=i(v),p=s.default(b.Box)`
  svg {
    width: 1rem;
    height: 1rem;
  }
`,f=s.default(j.BaseLink)`
  position: relative;

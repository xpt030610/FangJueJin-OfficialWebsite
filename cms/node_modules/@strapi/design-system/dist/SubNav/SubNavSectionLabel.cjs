"use strict";Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const f=require("react"),g=require("prop-types"),y=require("styled-components"),b=require("@strapi/icons"),u=require("../Typography/Typography.cjs"),s=require("../Box/Box.cjs"),x=require("../Flex/Flex.cjs"),r=e=>e&&typeof e=="object"&&"default"in e?e:{default:e},t=r(f),a=r(g),i=r(y),d=i.default(x.Flex)`
  border: none;
  padding: 0;

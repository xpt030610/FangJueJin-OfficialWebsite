"use strict";Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const y=require("react"),g=require("prop-types"),m=require("react-router-dom"),b=require("styled-components"),h=require("@strapi/icons"),a=require("../Box/Box.cjs"),c=require("../Typography/Typography.cjs"),s=require("../Flex/Flex.cjs"),n=e=>e&&typeof e=="object"&&"default"in e?e:{default:e},t=n(y),r=n(g),i=n(b),x=i.default(a.Box)`
  display: flex;
  align-items: center;

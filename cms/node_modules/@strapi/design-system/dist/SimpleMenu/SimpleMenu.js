...
const C = ({
  ...
  const m = T(), R = Y("simplemenu", s), x = T(!1), [d, f] = B(!1), [D, I] = B(0), h = z.toArray(E), A = a || (c === "S" ? oe : $), S = !!u && typeof u == "function";
  v(() => {
  ...
  const w = K(l), M = K(P);
  v(() => {
    x?.current ? d ? w() : M() : x.current = !0;
  }, [x, M, w, d]), v(() => {
    t.isValidElement(o) && D === -1 && m.current.focus();
  }, [o, D]);
  const N = (n) => {
    d && (n.key === i.ESCAPE && (n.stopPropagation(), f(!1), m.current.focus()), n.key === i.DOWN && I((r) => r === h.length - 1 ? 0 : r + 1), n.key === i.UP && I((r) => r === 0 ? h.length - 1 : r - 1));
  }, F = (n) => {
    ...
    onClick() {
      n.props.onClick(), f(!1), m.current.focus();
    },
    isFocused: D === r
  })));
  return /* @__PURE__ */ t.createElement("div", {
    ...
    ...g
  }, o), d && /* @__PURE__ */ t.createElement(X, {
    onBlur: V,
    placement: p,
    source: m,
    onReachEnd: W,

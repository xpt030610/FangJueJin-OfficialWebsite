"use strict";Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const g=require("react"),m=require("prop-types"),y=require("styled-components"),d=require("react-router-dom"),r=require("../Box/Box.cjs"),s=require("../Typography/Typography.cjs"),x=require("../Flex/Flex.cjs"),h=require("./MainNavContext.cjs"),c=require("../VisuallyHidden/VisuallyHidden.cjs"),l=e=>e&&typeof e=="object"&&"default"in e?e:{default:e},t=l(g),a=l(m),f=l(y),p=f.default.div`
  svg,
  img {

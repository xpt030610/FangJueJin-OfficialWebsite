...
import { DefaultTabsRow as R, SimpleTabBox as B, DefaultTabButton as K, DefaultTabBox as P } from "./components.js";
const A = E.button`
  &[aria-disabled='true'] {
    cursor: not-allowed;
  }
`, N = ({ children: b, ...p }) => {
  const { id: h, selectedTabIndex: c, selectTabIndex: o, label: m, variant: u, onTabChange: y } = k(), f = w(c, y), a = C.toArray(b).map(
    (t, s) => D(t, {
      id: `${h}-${s}`,
      index: s,
      selectedTabIndex: c,
  ...
  return u === "simple" ? /* @__PURE__ */ l.createElement("div", {
    ref: f,
    role: "tablist",
    "aria-label": m,
    onKeyDown: x,
    ...p
  }, a) : /* @__PURE__ */ l.createElement(R, {
    ref: f,
    role: "tablist",
    alignItems: "flex-end",
    "aria-label": m,
...
const v = ({ disabled: b, id: p, children: h, variant: c, hasError: o, index: m, selectedTabIndex: u, onTabClick: y, ...f }) => {
  ...
  if (c === "simple") {
    let e;
    return o ? e = "danger600" : t ? e = "primary600" : e = "neutral600", /* @__PURE__ */ l.createElement(A, {
      id: a,
      role: "tab",
  ...
  return /* @__PURE__ */ l.createElement(K, {
    ...
    padding: t ? 4 : 3,
    background: t ? "neutral0" : "neutral100",
    selected: t
  }, /* @__PURE__ */ l.createElement(I, {
    fontWeight: "bold",
    textColor: t ? "primary700" : "neutral600"
  }, h)));
};
v.defaultProps = {
  disabled: !1,

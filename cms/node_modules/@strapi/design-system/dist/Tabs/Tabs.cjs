"use strict";Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const v=require("react"),K=require("prop-types"),q=require("styled-components"),_=require("./TabsContext.cjs"),D=require("../Typography/Typography.cjs"),x=require("../helpers/keyboardKeys.cjs"),w=require("./useTabsFocus.cjs"),m=require("./components.cjs"),C=n=>n&&typeof n=="object"&&"default"in n?n:{default:n},d=C(v),l=C(K),R=C(q),j=R.default.button`
  &[aria-disabled='true'] {
    cursor: not-allowed;
  }
